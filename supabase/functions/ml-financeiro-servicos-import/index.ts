...
const CABECALHOS=["Id","Status Fatura","Fatura","Forma pagamento","Cliente","CNPJ/CPF","Solicitante","Contrato","Amostra Referência","Ordem de Serviço","Status Ordem serviço","Data do Agendamento","Data de Recepção","Data de Emissão da Nota","Data de Vencimento","Data de Pagamento","Total","Empresa","Obs"];

function modelo(){
 const wb=XLSX.utils.book_new();
 const instrucoes=[["MODELO DE IMPORTAÇÃO — SERVIÇOS GERADOS"],["MinasLab / M Lab — Módulo Financeiro"],[],["COMO USAR"],["1. Preencha os dados na aba Serviços, a partir da linha 2."],["2. Na coluna Empresa informe exatamente MinasLab ou M Lab. Essa informação define a empresa de emissão da OS."],["3. As duas linhas EXEMPLO são ignoradas automaticamente; apague-as antes de importar se desejar."],["4. Não renomeie, não reordene e não exclua colunas. O cabeçalho deve permanecer na linha 1."],["5. Salve em .xlsx e importe em Financeiro > Serviços Gerados."],["6. Informe Data de Emissão da Nota quando a nota já tiver sido emitida."],["7. Datas inválidas ou 30/11/-0001 são tratadas como sem data."],["8. Em OS já faturadas, a importação só preenche a emissão quando ela estiver vazia."]];
 const exemplos=[CABECALHOS,[1,"Em Aberto","EXEMPLO-001","Boleto bancário, 10 dias","Cliente Exemplo Ltda","00.000.000/0001-00","Sem solicitante","00000001/2026","AM00000001/2026","OS00001/2026","Concluída","01/09/2026","01/09/2026","","11/09/2026","30/11/-0001",150,"MinasLab","Linha de exemplo"],[2,"Pago","EXEMPLO-002","Pix ou a vista - 1 dia","Pessoa Exemplo","000.000.000-00","Sem solicitante","00000002/2026","AM00000002/2026","OS00002/2026","Concluída","02/09/2026","02/09/2026","02/09/2026","02/09/2026","02/09/2026",200,"M Lab","Linha de exemplo"]];
 const listas=[["Status Fatura","Status Ordem serviço","Forma pagamento","Empresa"],["Em Aberto","Faturamento","Boleto bancário, 10 dias","MinasLab"],["Pago","Parcelado","Boleto bancário, 30 dias","M Lab"],["Faturamento","Concluída","Pix ou a vista - 1 dia",""] ,["Aguardando fechamento","Laboratorio","Cartão de Credito",""] ,["Cancelada","Cancelada","Boleto bancário, 2 parcelas",""]];
...
Deno.serve(async req=>{
 ...
 try{
  ...
  await emLotes([...unicos.entries()],async([ok,r])=>{
   ...
   const sg=statusGL(get(r,"status fatura")),venc=dt(get(r,"data de vencimento")),valor=num(get(r,"total excel","total"));let fat="AGUARDANDO",pag="AGUARDANDO";
