...
// Sugestões editáveis para começar; criadas somente por ação explícita.
export const SETORES_PADRAO = [
  {sigla:'LAB', nome:'Laboratório', area:'Operações'},
  {sigla:'CAM', nome:'Coletas de campo', area:'Operações'},
  {sigla:'ALM', nome:'Almoxarifado', area:'Operações'},
  {sigla:'ADM', nome:'Administração', area:'Gestão'},
  {sigla:'TIC', nome:'TI e sistemas', area:'Apoio'},
];
...
export const NOMES_GENERICOS = [
  ...
  "Balança", "Microscópio", "Estufa", "Autoclave", "Centrífuga",
  "pHmetro", "Espectrofotômetro", "Pipeta", "Equipamento de coleta", "Compressor",
