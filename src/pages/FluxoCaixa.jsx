...
export default function FluxoCaixa() {
  ...
  const [limiteTabela, setLimiteTabela] = useState(25);
  ...
  useEffect(() => { setPaginaTabela(1); }, [busca, mesFiltro, categoriaFiltro, tipoFiltro, statusFiltro, limiteTabela, empresa, de, ate]);
  ...
  const paginasTabela = Math.max(1, Math.ceil(tabela.length / limiteTabela));
  const tabelaPagina = useMemo(() => tabela.slice((paginaTabela - 1) * limiteTabela, paginaTabela * limiteTabela), [tabela, paginaTabela, limiteTabela]);
