...
export default function EmitirNfse(){
  ...
  return <div className="space-y-5">
    <div className="flex items-center gap-3"><button className="btn-ghost h-9 w-9 p-0" onClick={()=>navigate("/financas/notas")}><ArrowLeft size={18}/></button><PageTitle titulo="Emitir NFS-e — M Lab" descricao="Cliente central, rascunho fiscal, pré-validação e emissão pelo Emissor Nacional."/></div>
