...
export default function FinanceiroLayout(){
 ...
 return <div className={classes} onClickCapture={capturarCliqueContextual}>
  ...
  {location.pathname==="/financas/servicos-gerados"&&<section className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-blue-100 bg-blue-50/50 p-4 shadow-sm"><div><p className="font-bold text-slate-900">Modelo de importação — Serviços Gerados</p><p className="text-sm text-slate-600">Baixe o modelo aprovado, mantenha a aba <b>Serviços</b> e as 18 colunas na mesma ordem e importe o arquivo preenchido nesta tela.</p></div><div className="flex flex-wrap gap-2"><ServicosGeradosPrintButton/><button type="button" className="btn-outline" onClick={baixarModelo} disabled={baixandoModelo}><Download size={16}/>{baixandoModelo?"Baixando...":"Baixar modelo"}</button></div></section>}
