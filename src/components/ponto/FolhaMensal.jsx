...
export default function FolhaMensal({pessoas=[],pontoDia=[],competencia,editavel}){
 ...
 return <div className="space-y-4"><Card>
  ...
  {!pessoa?<Empty>Selecione um funcionário para visualizar a folha.</Empty>:linhas.length===0?<Empty>Nenhuma marcação encontrada nesta competência.</Empty>:<div className="overflow-x-auto"><div className="min-w-[980px] rounded-xl border bg-white p-4" style={{borderColor:"var(--hairline)"}}>
   ...
   <div className="mb-2 flex gap-6 border-y py-2 text-xs font-medium" style={{borderColor:"var(--hairline)"}}><span>Legenda</span><span>Feriado</span><span>Dia de descanso</span><span>Férias</span></div>
