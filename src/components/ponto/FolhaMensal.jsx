...
export default function FolhaMensal({pessoas=[],pontoDia=[],competencia,editavel}){
 const imprimirFolha=()=>{document.body.classList.add("imprimir-folha-mensal");const limpar=()=>{document.body.classList.remove("imprimir-folha-mensal");window.removeEventListener("afterprint",limpar)};window.addEventListener("afterprint",limpar);window.print()};
