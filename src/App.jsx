...
export default function App(){const[,setVersao]=useState(0);useEffect(()=>aoMudarSessao(()=>setVersao(v=>v+1)),[]);return <BrowserRouter basename={import.meta.env.BASE_URL}><Suspense fallback={<div className="p-8"><CarregandoModulo/></div>}><Routes><Route path="/entrar" element={<Login/>}/><Route element={<Guarda><Layout/></Guarda>}><Route path="/" element={<Home/>}/><Route path="/calendario" element={<Calendario/>}/><Route path="/compromissos" element={<Compromissos/>}/><Route path="/licitacoes" element={<Licitacoes/>}/><Route path="/marketing" element={<Marketing/>}/><Route path="/compras" element={<Compras/>}/><Route path="/manutencoes" element={<Manutencoes/>}/><Route path="/laboratorio" element={<Laboratorio/>}/><Route path="/rh" element={<Guarda modulo="rh"><RH/></Guarda>}/><Route path="/ponto" element={<Guarda modulo="ponto"><Ponto/></Guarda>}/><Route path="/financas" element={<Guarda modulo="financas"><Financas/></Guarda>}/><Route path="/financas/dashboard" element={<Guarda modulo="financas"><FinanceiroDashboard/></Guarda>}/><Route path="/financas/recebimentos" element={<Guarda modulo="financas"><Recebimentos/></Guarda>}/><Route path="/financas/despesas" element={<Guarda modulo="financas"><Despesas/></Guarda>}/><Route path="/financas/notas-fiscais" element={<Guarda modulo="financas"><NotasFiscais/></Guarda>}/><Route path="/financas/notas-fiscais/emitir" element={<Guarda modulo="financas"><EmitirNfse/></Guarda>}/><Route path="/financas/notas-fiscais/cancelar" element={<Guarda modulo="financas"><CancelarNfse/></Guarda>}/><Route path="/financas/notas-fiscais/importar-historico" element={<Guarda modulo="financas"><ImportarNfseHistorico/></Guarda>}/><Route path="/financas/clientes" element={<Guarda modulo="financas"><ClientesFinanceiro/></Guarda>}/><Route path="/financas/extrato" element={<Guarda modulo="financas"><Extrato/></Guarda>}/><Route path="/financas/fluxo-caixa" element={<Guarda modulo="financas"><FluxoCaixa/></Guarda>}/><Route path="/financas/plano-contas" element={<Guarda modulo="financas"><PlanoContas/></Guarda>}/><Route path="/financas/configuracoes" element={<Guarda modulo="financas"><ConfigFinanceiro/></Guarda>}/><Route path="/curva-abc" element={<Guarda modulo="curva-abc"><CurvaAbc/></Guarda>}/><Route path="/acessos" element={<Guarda modulo="acessos"><Acessos/></Guarda>}/><Route path="*" element={<Navigate to="/" replace/>}/></Route></Routes></Suspense></BrowserRouter>}
